...
<body>
  <div class="header-top">
	 <div class="wrap"> 
		<div class="logo">
			<a href="index.html"><img src=<?php echo ROOTWWW; ?>view/templates/sport_white/images/logo.png" alt=""/></a>
	    </div>
	    <div class="cssmenu">
		   <ul>
        ...
        <div class="footer">
       	  <div class="footer-top">
       		<div class="wrap">
       			   <div class="col_1_of_footer-top span_1_of_footer-top">
				  	 <ul class="f_list">
				  	 	<li><img src=<?php echo ROOTWWW; ?>view/templates/sport_white/images/f_icon.png" alt=""/><span class="delivery">Free delivery on all orders over £100*</span></li>
				  	 </ul>
				   </div>
				   <div class="col_1_of_footer-top span_1_of_footer-top">
				  	<ul class="f_list">
				  	 	<li><img src=<?php echo ROOTWWW; ?>view/templates/sport_white/images/f_icon1.png" alt=""/><span class="delivery">Customer Service :<span class="orange"> (800) 000-2587 (freephone)</span></span></li>
				  	 </ul>
				   </div>
				   <div class="col_1_of_footer-top span_1_of_footer-top">
				  	<ul class="f_list">
				  	 	<li><img src=<?php echo ROOTWWW; ?>view/templates/sport_white/images/f_icon2.png" alt=""/><span class="delivery">Fast delivery & free returns</span></li>
				  	 </ul>
				   </div>
				  <div class="clear"></div>
			 </div>
       	 ...
       	 <div class="footer-middle">
				...
				<div class="col_1_of_middle span_1_of_middle">
			        ...
			        <dd>
			            <ul>
			                <li><a href="#">Australia<img class="flag" src=<?php echo ROOTWWW; ?>view/templates/sport_white/images/as.png" alt="" /><span class="value">AS</span></a></li>
			                <li><a href="#">Sri Lanka<img class="flag" src=<?php echo ROOTWWW; ?>view/templates/sport_white/images/srl.png" alt="" /><span class="value">SL</span></a></li>
			                <li><a href="#">Newziland<img class="flag" src=<?php echo ROOTWWW; ?>view/templates/sport_white/images/nz.png" alt="" /><span class="value">NZ</span></a></li>
			                <li><a href="#">Pakistan<img class="flag" src=<?php echo ROOTWWW; ?>view/templates/sport_white/images/pk.png" alt="" /><span class="value">Pk</span></a></li>
			                <li><a href="#">United Kingdom<img class="flag" src=<?php echo ROOTWWW; ?>view/templates/sport_white/images/uk.png" alt="" /><span class="value">UK</span></a></li>
			                <li><a href="#">United States<img class="flag" src=<?php echo ROOTWWW; ?>view/templates/sport_white/images/us.png" alt="" /><span class="value">US</span></a></li>
			            </ul>
			         </dd>
   				    </dl>
   				 </div>
